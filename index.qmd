...
<!-- precise-caption-table-1 -->
*Table 1. Overall sentiment distribution in the airline tweet dataset.*
...
ggplot(sentiment_by_airline, aes(x = airline, y = share, fill = airline_sentiment)) +
  ...
  theme_minimal()
```
<!-- precise-caption-figure-1 -->
*Figure 1. Sentiment distribution by airline.*
...
<!-- precise-caption-table-2 -->
*Table 2. Main negative reasons in customer tweets.*
...
negative_reasons |>
  ...
  theme_minimal()
```
<!-- precise-caption-figure-2 -->
*Figure 2. Most frequent negative reasons behind airline-related complaints.*
...
<!-- precise-caption-table-3 -->
*Table 3. Most frequent words after tokenization and stop-word removal.*
...
# Lexicon Choices for Sentiment Analysis

Lexicon-based sentiment analysis can use different dictionaries. In this project, the Bing lexicon is used, but other lexicons such as AFINN and NRC are also available.

| Lexicon | Output type | What it shows | Why / when useful |
|---|---|---|---|
| Bing | Positive / negative categories | Whether matched words are positive or negative | Simple, transparent, and suitable for a short RStudio demonstration |
| AFINN | Numerical sentiment score | Direction and intensity of sentiment | Useful when the strength of sentiment matters |
| NRC | Emotion categories | Emotions such as anger, fear, joy, sadness, and trust | Useful for richer emotional analysis |

In this handout, the Bing lexicon is used because it is simple, transparent, and easy to reproduce during a short presentation. It clearly shows which words are classified as positive or negative. Other lexicons could provide more detailed results, but Bing is the most suitable choice for demonstrating the basic logic of lexicon-based sentiment analysis.
...
<!-- precise-caption-table-4 -->
*Table 4. Positive and negative word counts using the Bing lexicon.*
...
<!-- precise-caption-table-5 -->
*Table 5. Most frequent positive and negative sentiment words.*
...
top_sentiment_words |>
  ...
  theme_minimal()
```
<!-- precise-caption-figure-3 -->
*Figure 3. Most frequent sentiment words identified with the Bing lexicon.*
...
<!-- precise-caption-table-6 -->
*Table 6. Managerial actions derived from negative reason categories.*
