...
<div class='example-card'>
<b>Example</b><br><br>
<span class='token negative-token'>terrible</span> → negative<br>
<span class='token negative-token'>delayed</span> → negative<br>
<span class='token positive-token'>helpful</span> → positive<br>
<span class='token positive-token'>comfortable</span> → positive
<br><br>
<span class='mini-note'>Words not found in the dictionary are not labelled as neutral; they are excluded.</span>
</div>
</div>
