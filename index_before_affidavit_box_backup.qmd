...
Mustafa Asım Ruhi, \[02/06/2026\], \[Köln\]
:::
...
- [ ] The title page of the presentation and the handout contain personal details.
- [ ] The handout contains a bibliography created using BibTeX with APA citation style.
- [ ] Either the handout or the presentation contains R code that proves coding expertise.
